...
typeset FA__CNV__TEST_NAMESPACE="${FA__CNV__TEST_NAMESPACE:-cnv-migration-test}"
typeset FA__CNV__VM_NAME="${FA__CNV__VM_NAME:-test-migration-vm}"
...
typeset FA__CNV__VM_MIGRATION_TIMEOUT="${FA__CNV__VM_MIGRATION_TIMEOUT:-30m}"
