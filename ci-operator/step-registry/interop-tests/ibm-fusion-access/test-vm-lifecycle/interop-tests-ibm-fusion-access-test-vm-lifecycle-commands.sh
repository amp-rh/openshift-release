...
typeset FA__CNV__TEST_NAMESPACE="${FA__CNV__TEST_NAMESPACE:-cnv-lifecycle-test}"
typeset FA__CNV__VM_NAME="${FA__CNV__VM_NAME:-test-lifecycle-vm}"
...
YAML
  ...
  yq -p json -o yaml eval - | oc apply -f -; then
